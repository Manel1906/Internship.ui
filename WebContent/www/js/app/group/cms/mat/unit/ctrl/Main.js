define([
        ...
        'text!group/mat/unit/tmpl/Main.html',
        
        'group/mat/unit/ctrl/List',
        'group/mat/unit/ctrl/Ent'      
...
//				do_gl_apply_right($(pr_divContent));
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "mat.unit", "Main", "do_lc_show", e.toString()) ;
			}
		};
	};
