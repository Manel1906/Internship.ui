define([
	'jquery',
	'text!group/mat/unit/tmpl/Ent_Btn.html',
	'text!group/mat/unit/tmpl/Ent_Btn_Sub.html',
	],
	...
	var CtrlEntBtn     = function (header,content,footer,grpName) {
		...
		this.do_lc_show		= function(obj, mode){
			...
			try{
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "mat.unit", "EntBtn", "do_lc_show", e.toString()) ;
			}
		};
