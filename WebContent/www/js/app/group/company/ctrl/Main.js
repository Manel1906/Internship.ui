define([
	...
	'group/company/ctrl/List',
	'group/company/ctrl/Ent',
	
	'text!group/company/tmpl/Main.html',
	'text!group/company/tmpl/List.html', 
	'text!group/company/tmpl/List_Content.html', 
	
	'text!group/company/tmpl/Ent.html',
	'text!group/company/tmpl/Ent_Content.html'	,
	'text!group/company/tmpl/Ent_Tab_JobPosition.html'	,
	'text!group/company/tmpl/Ent_Tab_Person_Info.html',	
	'text!group/company/tmpl/Ent_Tab_Rights.html',
	
	'text!group/company/tmpl/Sel_List_Legal_Status.html'	,
	'text!group/company/tmpl/Dropzone_File.html'
	...
	var PrjCompanyMain     			= function (grpName, header, content, footer) {
		var pr_divHeader 			= header;
		var pr_divContent 			= content;
		var pr_divFooter 			= footer;
		
		//------------------------------------------------------------------------------------
		var pr_grpName				= grpName?grpName:"PrjMngClient";
...
//				2: "aut_user_ent_header_type_adm"	,	20: "aut_user_ent_header_type_doctor"	,	30: "aut_user_ent_header_type_agent"
				200: "aut_user_ent_header_type_morale"
		}
		...
		this.do_lc_show_callback = function(){    
			try { 
				...
				$(document).prop('title',$.i18n('prj_project_sidebar_company'));

			}catch(e) {				
				console.log(e); //do_gl_send_exception(App.path.BASE_URL_API_PRIV, App.data["HttpSecuHeader"], App.network, "prj.chatRoom", "PrjCompanyMain", "do_lc_show", e.toString()) ;
			}
		}
		
	};

	return PrjCompanyMain;
});