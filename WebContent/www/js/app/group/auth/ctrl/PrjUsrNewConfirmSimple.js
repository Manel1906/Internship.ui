define([
        ...
        'text!group/auth/tmpl/Usr_New_Confirm_Simple.html'
	...
	var PrjUsrNewConfirmSimple 	= function (header, content, footer) {
		...
		//------------------controllers------------------------------------------------------
		var pr_ctr_UsrMain			= null;
		var pr_ctr_UsrNewConfirm 	= null;
		...
		function doNewConfirm_Ajax(data) {
			var ref = req_gl_Request_Content_Send('ServiceAuthentification','SVValidationSimple');
