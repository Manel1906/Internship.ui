define([
        'jquery',
        'text!group/mat/unit/tmpl/List.html'   ,
        'text!group/mat/unit/tmpl/List_Stat_New.html',
        'text!group/mat/unit/tmpl/List_Stat_Act.html', 
        'text!group/mat/unit/tmpl/List_Stat_Rev.html',
        'text!group/mat/unit/tmpl/List_Stat_Del.html' 
        ],
        function($, 
        		Tmpl_List,
	...
	var CtrlList 	= function (grpName, header, content, footer) {
		...
		//------------------------------------------------------------------------------------
		var pr_SERVICE_CLASS		= "ServiceMatUnit"; //to change by your need
		...
		this.do_lc_show = function(){               
			try{
				...
				self.do_lc_show_byTypeStat("#div_List_Stat_New", tmplName.LIST_STAT_NEW, null, "[0]");
				self.do_lc_show_byTypeStat("#div_List_Stat_Act", tmplName.LIST_STAT_ACT, null, "[1]");
				self.do_lc_show_byTypeStat("#div_List_Stat_Rev", tmplName.LIST_STAT_REV, null, "[5]");
				self.do_lc_show_byTypeStat("#div_List_Stat_Del", tmplName.LIST_STAT_DEL, null, "[10]");
				//---------------------------------------------------------------
				App.controller.DBoard.DBoardMain.do_lc_bind_event_div_Minimize();
			}catch(e) {	
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "mat.unit", "List", "do_lc_show", e.toString()) ;
			}
		};
