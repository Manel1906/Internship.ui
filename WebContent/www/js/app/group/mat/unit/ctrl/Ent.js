define([
		'jquery',
		'text!group/mat/unit/tmpl/Ent.html',
		
		'group/mat/unit/ctrl/EntHeader',
	    'group/mat/unit/ctrl/EntBtn' 
//		'group/mat/unit/ctrl/EntTabs' 
...
//				pr_ctr_EntTabs 			= App.controller[pr_grpName].EntTabs;
	...
	//				pr_ctr_EntTabs		.do_lc_show(pr_obj, pr_mode);
					...
					console.log(e);
					do_gl_exception_send(App.path.BASE_URL_API_PRIV, "mat.unit", "Ent", "do_lc_show", e.toString()) ;
				}
			}
