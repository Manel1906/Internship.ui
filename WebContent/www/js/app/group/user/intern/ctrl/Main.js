define([
	...
	'group/user/intern/ctrl/List',
	'group/user/intern/ctrl/Ent',
	
	'text!group/user/intern/tmpl/Main.html',
	'text!group/user/intern/tmpl/List.html', 
	'text!group/user/intern/tmpl/List_Content.html', 
	
	'text!group/user/intern/tmpl/Ent.html',
	'text!group/user/intern/tmpl/Ent_Content.html'	,
	'text!group/user/intern/tmpl/Ent_Tab_JobPosition.html'	,
	'text!group/user/intern/tmpl/Ent_Tab_Person_Info.html',	
    
	'text!group/user/intern/tmpl/Ent_Tab_Rights.html',
	
	'text!group/user/intern/tmpl/Sel_List_Legal_Status.html'	,
	'text!group/user/intern/tmpl/Dropzone_File.html'
	...
	var PrjUserMain     			= function (grpName, header, content, footer) {
		...
		//------------------------------------------------------------------------------------
		var pr_grpName				= grpName?grpName:"UserIntern";
		...
		const TYP_USER = {
				2	: "aut_user_ent_header_type_adm"	,	
				20	: "aut_user_ent_header_type_doctor"	,	
				30	: "aut_user_ent_header_type_agent"
