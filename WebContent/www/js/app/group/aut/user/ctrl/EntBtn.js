define([
	'jquery',
	'text!group/aut/user/tmpl/Ent_Btn.html',
	'text!group/aut/user/tmpl/Ent_Btn_Sub.html',
	],
...
//				else
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "aut.user", "EntBtn", "do_lc_show", e.toString()) ;
			}
		};
