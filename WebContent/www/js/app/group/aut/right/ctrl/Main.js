define([
        ...
        'text!group/aut/right/tmpl/Main.html',
        
        'group/aut/right/ctrl/List',
        'group/aut/right/ctrl/Ent'      
	...
	var CtrlMain 	= function (grpName, header, content, footer) {
		...
		var pr_grpPath				= 'group/aut/right';
...
//				do_gl_apply_right($(pr_divContent));
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "aut.right", "Main", "do_lc_show", e.toString()) ;
			}
		};
	};
