define([
		'jquery',
		'text!group/aut/auth_service/tmpl/Ent.html',
		
		'group/aut/auth_service/ctrl/EntHeader',
	    'group/aut/auth_service/ctrl/EntBtn' 
//		'group/aut/auth_service/ctrl/EntTabs' 
...
//				pr_ctr_EntTabs 			= App.controller[pr_grpName].EntTabs;
	...
	//				pr_ctr_EntTabs		.do_lc_show(pr_obj, pr_mode);
					...
					console.log(e);
					do_gl_exception_send(App.path.BASE_URL_API_PRIV, "aut.auth_service", "Ent", "do_lc_show", e.toString()) ;
				}
			}
