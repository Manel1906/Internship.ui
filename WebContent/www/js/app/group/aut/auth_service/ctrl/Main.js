define([
        ...
        'text!group/aut/auth_service/tmpl/Main.html',
        
        'group/aut/auth_service/ctrl/List',
        'group/aut/auth_service/ctrl/Ent'      
	...
	var CtrlMain 	= function (grpName, header, content, footer) {
		...
		var pr_grpPath				= 'group/aut/auth_service';
...
//				do_gl_apply_right($(pr_divContent));
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "aut.auth_service", "Main", "do_lc_show", e.toString()) ;
			}
		};
	};
