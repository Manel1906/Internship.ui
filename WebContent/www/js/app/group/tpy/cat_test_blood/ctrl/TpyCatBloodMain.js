define([
	...
	var TpyCatBloodMain     		= function (header,content,footer, grpName) {
		...
		this.do_lc_init		= function(){
			...
			if (!App.controller.TpyCatBlood) App.controller.TpyCatBlood = {};
			
			
			if (!App.controller.TpyCatBlood.List)  
				App.controller.TpyCatBlood.List				= new TpyCatBloodList		(null, null, null);
			
			if (!App.controller.TpyCatBlood.Member)  
				App.controller.TpyCatBlood.Member				= new TpyCatBloodMember	(null, null, null);
			
			
			App.controller.TpyCatBlood.List					.do_lc_init();
			App.controller.TpyCatBlood.Member					.do_lc_init();
			
			tmplName.TPY_CAT_Blood_MAIN = "TpyCatBlood_Main";
			tmplCtrl										.do_lc_put_tmpl(tmplName.TPY_CAT_Blood_MAIN, TpyCatBlood_Main); 
		}     
		...
		this.do_lc_show_callback = function(){
			try { 
				...
				$("#div_main_content")			.html(tmplCtrl.req_lc_compile_tmpl(tmplName.TPY_CAT_Blood_MAIN, {}));

				App.controller.TpyCatBlood.List.do_lc_show();
