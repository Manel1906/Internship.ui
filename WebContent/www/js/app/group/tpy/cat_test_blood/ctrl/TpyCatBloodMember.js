define([
  ...
  const TpyCatBloodMember = function (grpName, header, content, footer) {
    ...
    this.do_lc_init = function () {
      ...
      pr_ctr_Main = App.controller.TpyCatBlood.Main;
      pr_ctr_List = App.controller.TpyCatBlood.List;

      tmplName.PRJ_USER_GROUP_MEMBER = "TpyCatBlood_Member";
      tmplName.PRJ_USER_GROUP_MEMBER_DETAIL = "TpyCatBlood_Member_Detail";
    };
