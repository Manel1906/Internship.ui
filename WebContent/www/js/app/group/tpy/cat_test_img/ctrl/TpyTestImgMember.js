define([
  "text!group/tpy/cat_test_img/tmpl/TpyTestImg_Member.html",
  //	'text!group/user_group/tmpl/PrjUserGroup_Member_Detail.html',
], function (
  PrjUserGroup_Member
  //			PrjUserGroup_Member_Detail
) {
  const TpyTestImgMember = function (grpName, header, content, footer) {
    ...
    this.do_lc_init = function () {
      ...
      pr_ctr_Main = App.controller.TpyTestImg.Main;
      pr_ctr_List = App.controller.TpyTestImg.List;

      tmplName.PRJ_USER_GROUP_MEMBER = "TpyTestImg_Member";
      tmplName.PRJ_USER_GROUP_MEMBER_DETAIL = "TpyTestImg_Member_Detail";
    };
    ...
    this.do_lc_show = function (group) {
      try {
        ...
        console.log(e); //do_gl_send_exception(App.path.BASE_URL_API_PRIV, App.data["HttpSecuHeader"], App.network, "prj.project", "PrjUserGroupMember", "do_lc_show", e.toString()) ;
      }
    };
