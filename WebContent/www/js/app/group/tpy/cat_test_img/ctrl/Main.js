define([
	'group/tpy/cat_test_img/ctrl/List',
	'group/tpy/cat_test_img/ctrl/Ent',

	'text!group/tpy/cat_test_img/tmpl/Main.html',
	
	'text!group/tpy/cat_test_img/tmpl/List.html',
	'text!group/tpy/cat_test_img/tmpl/List_Content.html',
	
	'text!group/tpy/cat_test_img/tmpl/Ent_Content.html',
	'text!group/tpy/cat_test_img/tmpl/Ent_New.html',
	'text!group/tpy/cat_test_img/tmpl/Ent_Content_Row.html',
	'text!group/tpy/cat_test_img/tmpl/Ent_Content_Row_add.html',
	
	'text!group/tpy/cat_test_img/tmpl/Dropzone_File.html',
	...
	var Main     		= function (grpName, header,content,footer) {
		...
		//------------------------------------------------------------------------------------
		var pr_grpName				= grpName?grpName:"TpyCatTestImg";
