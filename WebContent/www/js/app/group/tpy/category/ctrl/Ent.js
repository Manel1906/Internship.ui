define([
	'jquery',
	'text!group/tpy/category/tmpl/Ent.html',
	
	'group/tpy/category/ctrl/EntHeader',
    'group/tpy/category/ctrl/EntBtn' 
	...
	var CtrlEnt     = function (header,content,footer,grpName) {
		...
		//------------------------------------------------------------------------------------
		var pr_lock_type			= 50300; //--const based on BO
	...
	//			pr_ctr_EntTabs		.do_lc_show(pr_obj, pr_mode);
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  "tpy.category", "Ent", "do_lc_show", e.toString()) ;
			}
		}
