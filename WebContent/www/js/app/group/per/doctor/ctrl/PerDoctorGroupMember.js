define([
  "text!group/per/doctor/tmpl/PerDoctorGroup_Member.html",
  //	'text!group/per/doctor/tmpl/PerDoctorGroup_Member_Detail.html',
], function (
  PerDoctorGroup_Member
  //			PerDoctorGroup_Member_Detail
) {
  const PerDoctorGroupMember = function (grpName, header, content, footer) {
	...
	const PRJ_MEMBER_LEVEL 		= {1: "prj_project_member_level_dean", 2: "prj_project_member_level_deputy", 10: "prj_project_member_level_doctor",
									20: "prj_project_member_level_pharmacist", 30: "prj_project_member_level_nurse", 100: "prj_project_member_level_member"};
    ...
    this.do_lc_init = function () {
      ...
      tmplName.PRJ_USER_GROUP_MEMBER = "PerDoctorGroup_Member";
      tmplName.PRJ_USER_GROUP_MEMBER_DETAIL = "PerDoctorGroup_Member_Detail";
    };
    ...
    this.do_lc_show = function (group) {
      try {
        ...
        console.log(e); //do_gl_send_exception(App.path.BASE_URL_API_PRIV, App.data["HttpSecuHeader"], App.network, "prj.project", "PerDoctorGroupMember", "do_lc_show", e.toString()) ;
      }
    };
