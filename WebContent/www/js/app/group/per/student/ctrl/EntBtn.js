define([
        'jquery',
        'text!group/per/student/tmpl/Ent_Btn.html',
        'text!group/per/student/tmpl/Ent_Btn_Sub.html',
        ],
...
//				else
				...
				do_gl_exception_send(App.path.BASE_URL_API_PRIV,  pr_grpName, "EntBtn", "do_lc_show", e.toString()) ;
			}
		};
		...
		var do_bind_event_btn_cancel		= function(obj, mode){
			...
			$(pr_btn_Cancel_Sub).click(function(){
				App.MsgboxController.do_lc_show({
					title	: $.i18n("tpy_cat_btn_cancel_title"),
					content : $.i18n("tpy_cat_btn_cancel_content"),
					buttons	: {
