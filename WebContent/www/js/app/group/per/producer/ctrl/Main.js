define([
	'group/per/producer/ctrl/List',
	'group/per/producer/ctrl/Ent',
	'group/per/producer/ctrl/EntTabInfo',
	'group/per/producer/ctrl/EntTabHistDisease',
	'group/per/producer/ctrl/EntTabHistMedicine',
	'group/per/producer/ctrl/EntTabOrderMedicine',
	'group/per/producer/ctrl/EntTabOrderBloodTest',
	'group/per/producer/ctrl/EntTabOrderImgTest',
	
	'text!group/per/producer/tmpl/Main.html',
	
	'text!group/per/producer/tmpl/List.html', 
	'text!group/per/producer/tmpl/List_Content.html', 
	
	'text!group/per/producer/tmpl/Ent.html',
	
	'text!group/per/producer/tmpl/Ent_Tab_Info_Modify.html',
	'text!group/per/producer/tmpl/Ent_Tab_Info.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_Info_Contact.html',
	'text!group/per/producer/tmpl/Ent_Tab_Info_Contact_Add.html',
	'text!group/per/producer/tmpl/Ent_Tab_Info_Insurance.html',
	'text!group/per/producer/tmpl/Ent_Tab_Info_Insurance_Add.html',
	'text!group/per/producer/tmpl/Ent_Tab_Info_File.html',
	'text!group/per/producer/tmpl/Ent_Tab_Disease_Hist.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_Disease_Hist_Chronic.html'	,	
	'text!group/per/producer/tmpl/Ent_Tab_Disease_Hist_Chronic_Add.html'	,	
	'text!group/per/producer/tmpl/Ent_Tab_Disease_Hist_Family.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_Disease_Hist_Family_Add.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_Disease_Hist_Allergy.html'	,	
	'text!group/per/producer/tmpl/Ent_Tab_Disease_Hist_Allergy_Add.html'	,
	
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_List.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_List_Content.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Content_New.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Content_ICD_Main_Select.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Content_ICD_Sub_Select.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Content.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Prescription.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Prescription_Add.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Test_Blood.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Test_Blood_Add.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Test_Img.html',
	'text!group/per/producer/tmpl/Ent_Tab_History_Medical_Test_Img_Add.html',
	
	'text!group/per/producer/tmpl/Ent_Tab_Order_Medical.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Medical_List.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_Order_Medical_List_Content.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Medical_Content.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Blood.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Blood_List.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Blood_List_Content.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Blood_Content.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Blood_Content_File.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Img.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Img_List.html'	,
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Img_List_Content.html',
	'text!group/per/producer/tmpl/Ent_Tab_Order_Test_Img_Content.html',
	
	'text!group/per/producer/tmpl/Dropzone_File.html',
	
	'text!group/per/producer/tmpl/Ent_New.html',
	...
	var Main     			= function (grpName, header, content, footer) {
		...
		//------------------------------------------------------------------------------------
		var pr_grpName				= grpName?grpName:"PerProducer";
		var tmplName				= App.template.names[pr_grpName];
		var tmplCtrl				= App.template.controller;
		
		var pr_grpPath 				= 'group/per/producer';
