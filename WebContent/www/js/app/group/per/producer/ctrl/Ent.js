define([
		...
		'group/per/producer/ctrl/EntHeader',
	    'group/per/producer/ctrl/EntBtn' 
//		'group/per/producer/ctrl/EntTabs' 
...
//				pr_ctr_EntTabs 			= App.controller[pr_grpName].EntTabs;
	...
	//				pr_ctr_EntTabs		.do_lc_show(pr_obj, pr_mode);
					...
					console.log(e);
					do_gl_exception_send(App.path.BASE_URL_API_PRIV, "per.producer", "Ent", "do_lc_show", e.toString()) ;
				}
			}
