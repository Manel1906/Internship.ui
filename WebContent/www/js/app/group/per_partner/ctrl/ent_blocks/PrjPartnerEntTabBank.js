define([
	...
	var PrjPartnerEntContent = function(deader, content, footer){
		...
		var do_lc_show_prj_content = function(prj, mode){
			$(pr_divContent)	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_PARTNER_ENT_CONTENT, prj));
			...
			$(pr_divTabObserv)		.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_PARTNER_ENT_TAB_OBSERVATION, prj));
			$(pr_divTabObservTab)	.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_PARTNER_ENT_TAB_OBSERVATION_LINE, prj));
//			$(pr_divTabBank)		.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_PARTNER_ENT_TAB_BANK, prj));
//			$(pr_divTabAddr)		.html(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_PARTNER_ENT_TAB_ADDRESS, prj));
