define([
	...
	'text!group/per_partner/tmpl/PrjPartner_Ent_Tab_Observation_Line.html',
	],
	function(	
...
//						info05: info05};
				...
				$(pr_divTabObservTab).append(tmplCtrl.req_lc_compile_tmpl(tmplName.PRJ_PARTNER_ENT_TAB_OBSERVATION_LINE, {tpyInfos:[newLine]}));
	...
	return PrjPartnerEntTabObservation;
});