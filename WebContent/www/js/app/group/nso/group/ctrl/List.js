define([
        'jquery',
        'text!group/nso/group/tmpl/List.html'   ,
        'text!group/nso/group/tmpl/List_Stat_All.html',
        'text!group/nso/group/tmpl/List_Stat_New.html',
        'text!group/nso/group/tmpl/List_Stat_Act.html', 
        'text!group/nso/group/tmpl/List_Stat_Rev.html',
        'text!group/nso/group/tmpl/List_Stat_Del.html' 
        ],
        function($, 
        		Tmpl_List,
