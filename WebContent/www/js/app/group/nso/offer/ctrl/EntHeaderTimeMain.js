define([
    ...
    'text!group/nso/offer/tmpl/Ent_Header_Time_Main.html',

    'group/nso/offer/ctrl/EntHeaderTimeList',
], function (
    $,
    Tmpl_Ent_Header_Time_Main,
    CtrlEntHeaderTimeList
) {
    var CtrlEntHeaderTimeMain = function (grpName, header, content, footer) {
        ...
        this.do_lc_init = function () {
            ...
            if (!App.controller[pr_grpName].EntHeaderTimeList)
                App.controller[pr_grpName].EntHeaderTimeList = new CtrlEntHeaderTimeList(null,
                    "#div_Ent_Header_Time_List", null, pr_grpName);
        ...
        this.do_lc_show = function (obj, mode) {
            ...
            try {
                ...
                console.log(e);
                do_gl_exception_send(App.path.BASE_URL_API_PRIV, "nso.offer", "CtrlEntHeaderTimeMain", "do_lc_show",
                    e.toString());
            }
        };
        ...
        this.do_lc_new_list = function (obj, mode) {
            ...
            try {
                ...
                $(pr_divContent).find('#main-content')
                                .append(tmplCtrl.req_lc_compile_tmpl(tmplName.ENT_HEADER_TIME_ITEM, data));
                // ++count;

            } catch (e) {
                console.log(e);
                do_gl_exception_send(App.path.BASE_URL_API_PRIV, "nso.offer", "CtrlEntHeaderTimeMain", "do_lc_new_list",
                    e.toString());
            }
        }
        ...
        this.do_lc_remove_list = function (obj) {
            try {
                ...
                console.log(e);
                do_gl_exception_send(App.path.BASE_URL_API_PRIV, "nso.offer", "CtrlEntHeaderTimeMain", "do_lc_remove_list",
                    e.toString());
            }
        }
