define([
	'jquery',
	'text!group/nso/offer/tmpl/Ent_Tab_Rating.html'
],
	function ($,
		Tmpl_Ent_Tab_Rating) {

		var CtrlEntTabRating = function (grpName, header, content, footer) {
			...
			this.do_lc_show = function (obj, mode) {
				...
				try {
					...
					console.log(e);
					do_gl_exception_send(App.path.BASE_URL_API_PRIV, "nso.offer", "CtrlEntTabRating", "do_lc_show", e.toString());
				}
			};
